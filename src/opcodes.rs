...
pub fn opcodes() -> &'static Vec<Opcode> {
...
pub fn opcode_map() -> &'static HashMap<u8, &'static Opcode> {
    static OPCODE_MAP: OnceLock<HashMap<u8, &'static Opcode>> = OnceLock::new();
    OPCODE_MAP.get_or_init(|| {
